...
function Icon({ name, size = 20, className = "", }) {
    return ((0,jsx_runtime.jsx)("svg", { className: `fill-current ${className}`, width: size.toString() + "px", height: size.toString() + "px", children: (0,jsx_runtime.jsx)("use", { xlinkHref: `/icons/solid.svg#${name}` }) }));
}

;// ./src/animationBlocks.ts
const motionBlocks = [
    {
        id: "moveSteps",
        labelComponents: [
...
var hooks_useIsomorphicLayoutEffect_useIsomorphicLayoutEffect = typeof window !== 'undefined' ? react.useLayoutEffect : react.useEffect;
...
var DndContext = (0,react.createContext)({
...
function useDragDropManager() {
  var _useContext = (0,react.useContext)(DndContext),
...
function _toConsumableArray(arr) { return _arrayWithoutHoles(arr) || _iterableToArray(arr) || useOptionalFactory_unsupportedIterableToArray(arr) || _nonIterableSpread(); }

function _nonIterableSpread() { throw new TypeError("Invalid attempt to spread non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); }

function useOptionalFactory_unsupportedIterableToArray(o, minLen) { if (!o) return; if (typeof o === "string") return useOptionalFactory_arrayLikeToArray(o, minLen); var n = Object.prototype.toString.call(o).slice(8, -1); if (n === "Object" && o.constructor) n = o.constructor.name; if (n === "Map" || n === "Set") return Array.from(o); if (n === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)) return useOptionalFactory_arrayLikeToArray(o, minLen); }

function _iterableToArray(iter) { if (typeof Symbol !== "undefined" && iter[Symbol.iterator] != null || iter["@@iterator"] != null) return Array.from(iter); }

function _arrayWithoutHoles(arr) { if (Array.isArray(arr)) return useOptionalFactory_arrayLikeToArray(arr); }

function useOptionalFactory_arrayLikeToArray(arr, len) { if (len == null || len > arr.length) len = arr.length; for (var i = 0, arr2 = new Array(len); i < len; i++) { arr2[i] = arr[i]; } return arr2; }
...
function DragSourceMonitorImpl_defineProperty(obj, key, value) { if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }
...
var DragSourceMonitorImpl = /*#__PURE__*/function () {
  function DragSourceMonitorImpl(manager) {
    ...
    DragSourceMonitorImpl_defineProperty(this, "internalMonitor", void 0);

    DragSourceMonitorImpl_defineProperty(this, "sourceId", null);
...
function isRef_typeof(obj) { "@babel/helpers - typeof"; if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { isRef_typeof = function _typeof(obj) { return typeof obj; }; } else { isRef_typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return isRef_typeof(obj); }

function isRef(obj) {
  return (// eslint-disable-next-line no-prototype-builtins
    obj !== null && isRef_typeof(obj) === 'object' && Object.prototype.hasOwnProperty.call(obj, 'current')
  );
}
;// ./node_modules/@react-dnd/shallowequal/dist/shallowequal.esm.js
function shallowequal_esm_shallowEqual(objA, objB, compare, compareContext) {
...
function SourceConnector_defineProperty(obj, key, value) { if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }
...
var SourceConnector = /*#__PURE__*/function () {
  ...
  function SourceConnector(backend) {
    ...
    SourceConnector_defineProperty(this, "hooks", wrapConnectorHooks({
    ...
    SourceConnector_defineProperty(this, "handlerId", null);

    SourceConnector_defineProperty(this, "dragSourceRef", null);

    SourceConnector_defineProperty(this, "dragSourceNode", void 0);

    SourceConnector_defineProperty(this, "dragSourceOptionsInternal", null);

    SourceConnector_defineProperty(this, "dragSourceUnsubscribe", void 0);

    SourceConnector_defineProperty(this, "dragPreviewRef", null);

    SourceConnector_defineProperty(this, "dragPreviewNode", void 0);

    SourceConnector_defineProperty(this, "dragPreviewOptionsInternal", null);

    SourceConnector_defineProperty(this, "dragPreviewUnsubscribe", void 0);

    SourceConnector_defineProperty(this, "lastConnectedHandlerId", null);

    SourceConnector_defineProperty(this, "lastConnectedDragSource", null);

    SourceConnector_defineProperty(this, "lastConnectedDragSourceOptions", null);

    SourceConnector_defineProperty(this, "lastConnectedDragPreview", null);

    SourceConnector_defineProperty(this, "lastConnectedDragPreviewOptions", null);

    SourceConnector_defineProperty(this, "backend", void 0);
  ...
  SourceConnector_createClass(SourceConnector, [{
    ...
    value: function didDragSourceOptionsChange() {
      return !shallowequal_esm_shallowEqual(this.lastConnectedDragSourceOptions, this.dragSourceOptions);
    }
  }, {
    key: "didDragPreviewOptionsChange",
    value: function didDragPreviewOptionsChange() {
      return !shallowequal_esm_shallowEqual(this.lastConnectedDragPreviewOptions, this.dragPreviewOptions);
    }
  }, {
...
function useDragSourceConnector(dragSourceOptions, dragPreviewOptions) {
  ...
  hooks_useIsomorphicLayoutEffect_useIsomorphicLayoutEffect(function () {
...
function useCollector_slicedToArray(arr, i) { return useCollector_arrayWithHoles(arr) || useCollector_iterableToArrayLimit(arr, i) || useCollector_unsupportedIterableToArray(arr, i) || useCollector_nonIterableRest(); }

function useCollector_nonIterableRest() { throw new TypeError("Invalid attempt to destructure non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); }

function useCollector_unsupportedIterableToArray(o, minLen) { if (!o) return; if (typeof o === "string") return useCollector_arrayLikeToArray(o, minLen); var n = Object.prototype.toString.call(o).slice(8, -1); if (n === "Object" && o.constructor) n = o.constructor.name; if (n === "Map" || n === "Set") return Array.from(o); if (n === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)) return useCollector_arrayLikeToArray(o, minLen); }

function useCollector_arrayLikeToArray(arr, len) { if (len == null || len > arr.length) len = arr.length; for (var i = 0, arr2 = new Array(len); i < len; i++) { arr2[i] = arr[i]; } return arr2; }
...
function useCollector(monitor, collect, onUpdate) {
  ...
  var updateCollected = (0,react.useCallback)(function () {
    ...
    if (!fast_deep_equal_default()(collected, nextValue)) {
...
function useMonitorOutput_iterableToArrayLimit(arr, i) { var _i = arr == null ? null : typeof Symbol !== "undefined" && arr[Symbol.iterator] || arr["@@iterator"]; if (_i == null) return; var _arr = []; var _n = true; var _d = false; var _s, _e; try { for (_i = _i.call(arr); !(_n = (_s = _i.next()).done); _n = true) { _arr.push(_s.value); if (i && _arr.length === i) break; } } catch (err) { _d = true; _e = err; } finally { try { if (!_n && _i["return"] != null) _i["return"](); } finally { if (_d) throw _e; } } return _arr; }
...
function DraggableBlock({ block }) {
    ...
    const renderPreview = () => {
        return block.labelComponents.map((component, index) => {
            var _a;
            switch (component.type) {
                case "text":
                    return ((0,jsx_runtime.jsx)("span", { className: "inline-block", children: component.value }, index));
                case "input":
                    return ((0,jsx_runtime.jsx)("span", { className: "inline-block border-b border-dotted px-1", children: block.params && block.params[component.key] !== undefined
                            ? block.params[component.key]
                            : "____" }, index));
                case "icon":
                    return ((0,jsx_runtime.jsx)(Icon, { name: component.name, size: (_a = component.size) !== null && _a !== void 0 ? _a : 15, className: "inline-block mx-1" }, index));
                default:
                    return null;
            }
        });
    };
    return ((0,jsx_runtime.jsx)("div", { ref: drag, className: `p-2 bg-blue-500 text-white m-1 rounded cursor-move ${isDragging ? "opacity-50" : "opacity-100"}`, children: renderPreview() }));
}
/* harmony default export */ const components_DraggableBlock = (DraggableBlock);
...
function Sidebar() {
    const dispatch = useDispatch();
    return ((0,jsx_runtime.jsxs)("div", { className: "w-60 flex-none h-full overflow-y-auto flex flex-col items-start p-2 border-r border-gray-200", children: [(0,jsx_runtime.jsxs)("div", { className: "font-bold", children: [" ", "Events", " "] }), (0,jsx_runtime.jsxs)("div", { className: "flex flex-row flex-wrap bg-yellow-500 text-white px-2 py-1 my-2 text-sm cursor-pointer", children: ["When ", (0,jsx_runtime.jsx)(Icon, { name: "flag", size: 15, className: "text-green-600 mx-2" }), "clicked"] }), (0,jsx_runtime.jsx)("div", { className: "flex flex-row flex-wrap bg-yellow-500 text-white px-2 py-1 my-2 text-sm cursor-pointer", children: "When this sprite clicked" }), (0,jsx_runtime.jsxs)("div", { className: "font-bold", children: [" ", "Motion", " "] }), motionBlocks.map((block) => ((0,jsx_runtime.jsx)(components_DraggableBlock, { block: block }, block.id))), (0,jsx_runtime.jsx)("div", { className: "font-bold", children: "Looks" }), looksBlocks.map((block) => ((0,jsx_runtime.jsx)(components_DraggableBlock, { block: block }, block.id)))] }));
}
...
function DropTargetImpl_classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }

function DropTargetImpl_defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }

function DropTargetImpl_createClass(Constructor, protoProps, staticProps) { if (protoProps) DropTargetImpl_defineProperties(Constructor.prototype, protoProps); if (staticProps) DropTargetImpl_defineProperties(Constructor, staticProps); return Constructor; }

function DropTargetImpl_defineProperty(obj, key, value) { if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }

var DropTargetImpl = /*#__PURE__*/function () {
  function DropTargetImpl(spec, monitor) {
    DropTargetImpl_classCallCheck(this, DropTargetImpl);

    DropTargetImpl_defineProperty(this, "spec", void 0);

    DropTargetImpl_defineProperty(this, "monitor", void 0);

    this.spec = spec;
    this.monitor = monitor;
  }

  DropTargetImpl_createClass(DropTargetImpl, [{
    key: "canDrop",
...
function useDropTarget(spec, monitor) {
  var dropTarget = (0,react.useMemo)(function () {
...
function useRegisteredDropTarget_slicedToArray(arr, i) { return useRegisteredDropTarget_arrayWithHoles(arr) || useRegisteredDropTarget_iterableToArrayLimit(arr, i) || useRegisteredDropTarget_unsupportedIterableToArray(arr, i) || useRegisteredDropTarget_nonIterableRest(); }

function useRegisteredDropTarget_nonIterableRest() { throw new TypeError("Invalid attempt to destructure non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); }

function useRegisteredDropTarget_unsupportedIterableToArray(o, minLen) { if (!o) return; if (typeof o === "string") return useRegisteredDropTarget_arrayLikeToArray(o, minLen); var n = Object.prototype.toString.call(o).slice(8, -1); if (n === "Object" && o.constructor) n = o.constructor.name; if (n === "Map" || n === "Set") return Array.from(o); if (n === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)) return useRegisteredDropTarget_arrayLikeToArray(o, minLen); }

function useRegisteredDropTarget_arrayLikeToArray(arr, len) { if (len == null || len > arr.length) len = arr.length; for (var i = 0, arr2 = new Array(len); i < len; i++) { arr2[i] = arr[i]; } return arr2; }

function useRegisteredDropTarget_iterableToArrayLimit(arr, i) { var _i = arr == null ? null : typeof Symbol !== "undefined" && arr[Symbol.iterator] || arr["@@iterator"]; if (_i == null) return; var _arr = []; var _n = true; var _d = false; var _s, _e; try { for (_i = _i.call(arr); !(_n = (_s = _i.next()).done); _n = true) { _arr.push(_s.value); if (i && _arr.length === i) break; } } catch (err) { _d = true; _e = err; } finally { try { if (!_n && _i["return"] != null) _i["return"](); } finally { if (_d) throw _e; } } return _arr; }

function useRegisteredDropTarget_arrayWithHoles(arr) { if (Array.isArray(arr)) return arr; }
...
function useRegisteredDropTarget(spec, monitor, connector) {
  ...
  hooks_useIsomorphicLayoutEffect_useIsomorphicLayoutEffect(function registerDropTarget() {
    var _registerTarget = registerTarget(accept, dropTarget, manager),
        _registerTarget2 = useRegisteredDropTarget_slicedToArray(_registerTarget, 2),
...
function DropTargetMonitorImpl_defineProperty(obj, key, value) { if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }
...
var DropTargetMonitorImpl = /*#__PURE__*/function () {
  function DropTargetMonitorImpl(manager) {
    ...
    DropTargetMonitorImpl_defineProperty(this, "internalMonitor", void 0);

    DropTargetMonitorImpl_defineProperty(this, "targetId", null);
...
function TargetConnector_defineProperty(obj, key, value) { if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }
...
var TargetConnector = /*#__PURE__*/function () {
  ...
  function TargetConnector(backend) {
    ...
    TargetConnector_defineProperty(this, "hooks", wrapConnectorHooks({
    ...
    TargetConnector_defineProperty(this, "handlerId", null);

    TargetConnector_defineProperty(this, "dropTargetRef", null);

    TargetConnector_defineProperty(this, "dropTargetNode", void 0);

    TargetConnector_defineProperty(this, "dropTargetOptionsInternal", null);

    TargetConnector_defineProperty(this, "unsubscribeDropTarget", void 0);

    TargetConnector_defineProperty(this, "lastConnectedHandlerId", null);

    TargetConnector_defineProperty(this, "lastConnectedDropTarget", null);

    TargetConnector_defineProperty(this, "lastConnectedDropTargetOptions", null);

    TargetConnector_defineProperty(this, "backend", void 0);
  ...
  TargetConnector_createClass(TargetConnector, [{
    ...
    value: function didOptionsChange() {
      return !shallowequal_esm_shallowEqual(this.lastConnectedDropTargetOptions, this.dropTargetOptions);
    }
  }, {
...
const spritesReducer = (state = initialState, action) => {
    switch (action.type) {
        case ADD_SPRITE:
            return Object.assign(Object.assign({}, state), { byId: Object.assign(Object.assign({}, state.byId), { [action.payload.id]: action.payload }), allIds: [...state.allIds, action.payload.id] });
        case UPDATE_SPRITE:
            return Object.assign(Object.assign({}, state), { byId: Object.assign(Object.assign({}, state.byId), { [action.payload.id]: Object.assign(Object.assign({}, state.byId[action.payload.id]), action.payload) }) });
        case TURN_SPRITE: {
            const { id, delta } = action.payload;
            const sprite = state.byId[id];
            if (!sprite)
                return state;
            return Object.assign(Object.assign({}, state), { byId: Object.assign(Object.assign({}, state.byId), { [id]: Object.assign(Object.assign({}, sprite), { rotation: sprite.rotation + delta }) }) });
        }
        case SET_SPEECH_BUBBLE: {
            const { id, bubble } = action.payload;
            return Object.assign(Object.assign({}, state), { byId: Object.assign(Object.assign({}, state.byId), { [id]: Object.assign(Object.assign({}, state.byId[id]), { speechBubble: bubble }) }) });
        }
        case DELETE_SPRITE: {
            const { id } = action.payload;
            const _a = state.byId, _b = id, removed = _a[_b], remaining = __rest(_a, [typeof _b === "symbol" ? _b : _b + ""]);
            return Object.assign(Object.assign({}, state), { byId: remaining, allIds: state.allIds.filter((spriteId) => spriteId !== id) });
        }
        default:
            return state;
    }
};
/* harmony default export */ const spriteReducer = (spritesReducer);
...
const turnSprite = (id, delta) => ({
    type: TURN_SPRITE,
    payload: { id, delta },
});
const setSpeechBubble = (id, bubble) => ({
...
const executeAction = (action, spriteId, sprite, actions, dispatch, currentX, currentY, currentRotation) => __awaiter(void 0, void 0, void 0, function* () {
    var _a, _b, _c, _d, _e, _f, _g, _h, _j, _k;
    switch (action.id) {
        case "moveSteps": {
            const steps = ((_a = action.params) === null || _a === void 0 ? void 0 : _a.steps) || 0;
        ...
        case "turnClockWiseDegrees": {
            const degrees = ((_b = action.params) === null || _b === void 0 ? void 0 : _b.degrees) || 0;
        ...
        case "turnAntiClockWiseDegrees": {
            const degrees = ((_c = action.params) === null || _c === void 0 ? void 0 : _c.degrees) || 0;
            dispatch(turnSprite(spriteId, -degrees));
            return { x: currentX, y: currentY, rotation: currentRotation - degrees };
        }
        case "goToXY": {
            const x = (_e = (_d = action.params) === null || _d === void 0 ? void 0 : _d.x) !== null && _e !== void 0 ? _e : currentX;
            const y = (_g = (_f = action.params) === null || _f === void 0 ? void 0 : _f.y) !== null && _g !== void 0 ? _g : currentY;
            dispatch(updateSprite({ id: spriteId, x, y, rotation: currentRotation }));
            return { x, y, rotation: currentRotation };
        }
        case "say":
        case "think": {
            const text = ((_h = action.params) === null || _h === void 0 ? void 0 : _h.text) || "";
            const seconds = parseFloat((_j = action.params) === null || _j === void 0 ? void 0 : _j.seconds) || 1;
            dispatch(setSpeechBubble(spriteId, { text, type: action.id }));
            yield delay(seconds * 1000);
            dispatch(setSpeechBubble(spriteId, null));
            return { x: currentX, y: currentY, rotation: currentRotation };
        }
        case "repeat": {
            const times = parseInt((_k = action.params) === null || _k === void 0 ? void 0 : _k.times) || 1;
            for (let i = 0; i < times; i++) {
                for (const repeatAction of actions) {
                    if (repeatAction.id !== "repeat") {
                        const result = yield executeAction(repeatAction, spriteId, sprite, actions, dispatch, currentX, currentY, currentRotation);
                        currentX = result.x;
                        currentY = result.y;
...
;// ./src/redux/reducers/editorReducer.ts
...
const editorReducer_initialState = {
    selectedSpriteId: null,
    actionSets: {},
};
const editorReducer = (state = editorReducer_initialState, action) => {
    switch (action.type) {
        case SET_SELECTED_SPRITE:
            return Object.assign(Object.assign({}, state), { selectedSpriteId: action.payload });
        case ADD_ACTION_TO_SPRITE: {
            const { spriteId, block } = action.payload;
            const current = state.actionSets[spriteId] || [];
            return Object.assign(Object.assign({}, state), { actionSets: Object.assign(Object.assign({}, state.actionSets), { [spriteId]: [...current, block] }) });
        }
        case UPDATE_ACTION_PARAM: {
            ...
            if (!spriteActions[blockIndex])
                return state;
            spriteActions[blockIndex] = Object.assign(Object.assign({}, spriteActions[blockIndex]), { params: Object.assign(Object.assign({}, spriteActions[blockIndex].params), { [paramKey]: value }) });
            return Object.assign(Object.assign({}, state), { actionSets: Object.assign(Object.assign({}, state.actionSets), { [spriteId]: spriteActions }) });
        }
        case REMOVE_ACTION_FROM_SPRITE: {
            ...
            return Object.assign(Object.assign({}, state), { actionSets: Object.assign(Object.assign({}, state.actionSets), { [spriteId]: updated }) });
        }
        case RESET_ACTION_SET_FOR_SPRITE: {
            const { spriteId } = action.payload;
            return Object.assign(Object.assign({}, state), { actionSets: Object.assign(Object.assign({}, state.actionSets), { [spriteId]: [] }) });
        }
        case SET_ACTION_SET: {
            const { spriteId, actions } = action.payload;
            return Object.assign(Object.assign({}, state), { actionSets: Object.assign(Object.assign({}, state.actionSets), { [spriteId]: actions }) });
        }
        default:
            return state;
    }
};
/* harmony default export */ const reducers_editorReducer = (editorReducer);
const setSelectedSprite = (id) => ({
    type: SET_SELECTED_SPRITE,
    payload: id,
});
const addActionToSprite = (spriteId, block) => ({
    type: ADD_ACTION_TO_SPRITE,
    payload: { spriteId, block },
});
const updateActionParam = (spriteId, blockIndex, paramKey, value) => ({
    type: UPDATE_ACTION_PARAM,
    payload: { spriteId, blockIndex, paramKey, value },
});
const removeActionFromSprite = (spriteId, blockIndex) => ({
    type: REMOVE_ACTION_FROM_SPRITE,
    payload: { spriteId, blockIndex },
});
const resetActionSetForSprite = (spriteId) => ({
    type: RESET_ACTION_SET_FOR_SPRITE,
    payload: { spriteId },
});
const setActionSet = (spriteId, actions) => ({
    type: SET_ACTION_SET,
...
const baseStyles = "px-4 py-2 rounded font-medium transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed";
const variantStyles = {
...
const Button = (_a) => {
    var { variant = "primary", className, children } = _a, props = Button_rest(_a, ["variant", "className", "children"]);
    return ((0,jsx_runtime.jsx)("button", Object.assign({ className: [baseStyles, variantStyles[variant], className]
            .filter(Boolean)
...
var MidArea_awaiter = (undefined && undefined.__awaiter) || function (thisArg, _arguments, P, generator) {
    function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); }
    return new (P || (P = Promise))(function (resolve, reject) {
        function fulfilled(value) { try { step(generator.next(value)); } catch (e) { reject(e); } }
        function rejected(value) { try { step(generator["throw"](value)); } catch (e) { reject(e); } }
...
function MidArea() {
    ...
    const dispatch = useDispatch();
    const selectedSpriteId = useSelector((state) => state.editor.selectedSpriteId);
    const sprite = useSelector((state) => selectedSpriteId ? state.sprites.byId[selectedSpriteId] : null);
    const actions = useSelector((state) => selectedSpriteId ? state.editor.actionSets[selectedSpriteId] || [] : []);
    const selectedRef = (0,react.useRef)(null);
    selectedRef.current = selectedSpriteId;
    const [{ isOver, canDrop }, drop] = useDrop(() => ({
        accept: MidArea_ItemTypes.BLOCK,
        drop: (item) => {
    ...
    const handleParamChange = (actionIndex, key, value) => {
        if (selectedSpriteId)
            dispatch(updateActionParam(selectedSpriteId, actionIndex, key, value));
    };
    const renderBlockWithInputs = (action, index) => {
        return ((0,jsx_runtime.jsx)("div", { children: action.labelComponents.map((component, i) => {
                var _a, _b, _c;
                switch (component.type) {
                    case "text":
                        return ((0,jsx_runtime.jsx)("span", { className: "inline-block", children: component.value }, i));
                    case "input":
                        return ((0,jsx_runtime.jsx)("input", { type: component.inputType || "number", className: "w-16 mx-1 border rounded px-1 text-black", value: (_b = (_a = action.params) === null || _a === void 0 ? void 0 : _a[component.key]) !== null && _b !== void 0 ? _b : "", onChange: (e) => handleParamChange(index, component.key, e.target.value) }, i));
                    case "icon":
                        return ((0,jsx_runtime.jsx)(Icon, { name: component.name, size: (_c = component.size) !== null && _c !== void 0 ? _c : 15, className: "inline-block mx-1" }, i));
                    default:
                        return null;
                }
            }) }));
    ...
    const runSequence = () => MidArea_awaiter(this, void 0, void 0, function* () {
        if (!selectedSpriteId || !sprite)
            return;
        setIsRunning(true);
        ...
        for (const action of actions) {
            if (shouldStop.current)
                break;
            const result = yield executeAction(action, sprite.id, sprite, actions, dispatch, currentX, currentY, currentRotation);
            currentX = result.x;
            currentY = result.y;
            currentRotation = result.rotation;
            if (shouldStop.current)
    ...
    return ((0,jsx_runtime.jsxs)("div", { className: "flex-1 h-full flex flex-col overflow-hidden", children: [(0,jsx_runtime.jsx)("h2", { className: "text-xl font-bold p-2", children: "Mid Area" }), (0,jsx_runtime.jsxs)("div", { ref: drop, className: "flex-1 overflow-auto flex flex-col items-center border-2 border-dashed p-4", children: [isOver && (0,jsx_runtime.jsx)("p", { className: "text-green-600", children: "Release to drop" }), canDrop && !isOver && (0,jsx_runtime.jsx)("p", { className: "text-gray-500", children: "Drag here" }), actions.map((action, index) => ((0,jsx_runtime.jsxs)("div", { className: "relative bg-blue-500 text-white p-2 m-1 rounded flex items-center", children: [(0,jsx_runtime.jsx)(components_Button, { variant: "danger", onClick: () => dispatch(removeActionFromSprite(selectedSpriteId, index)), className: "absolute -top-2 -right-2 text-white text-xs w-5 h-5 rounded-full flex items-center justify-center", children: "\u2715" }), renderBlockWithInputs(action, index)] }, `${action.id}-${index}`)))] }), (0,jsx_runtime.jsxs)("div", { className: "p-4 border-t bg-white flex gap-2", children: [(0,jsx_runtime.jsx)(components_Button, { variant: "secondary", onClick: runSequence, disabled: !sprite || actions.length === 0 || isRunning, className: "px-4 py-2 disabled:opacity-50", children: "Run Sequence" }), (0,jsx_runtime.jsx)(components_Button, { variant: "danger", onClick: () => {
                            shouldStop.current = true;
                            setIsRunning(false);
                        }, disabled: !isRunning, className: "px-4 py-2  disabled:opacity-50", children: "Stop" })] })] }));
}

;// ./src/components/CatSprite.tsx

function CatSprite() {
    return ((0,jsx_runtime.jsx)("svg", { xmlns: "http://www.w3.org/2000/svg", width: "95.17898101806641", height: "100.04156036376953", viewBox: "0.3210171699523926 0.3000000357627869 95.17898101806641 100.04156036376953", version: "1.1", xmlSpace: "preserve", children: (0,jsx_runtime.jsx)("g", { children: (0,jsx_runtime.jsx)("g", { id: "Page-1", stroke: "none", fillRule: "evenodd", children: (0,jsx_runtime.jsx)("g", { id: "costume1", children: (0,jsx_runtime.jsxs)("g", { id: "costume1.1", children: [(0,jsx_runtime.jsxs)("g", { id: "tail", children: [(0,jsx_runtime.jsx)("path", { d: "M 21.9 73.8 C 19.5 73.3 16.6 72.5 14.2 70.3 C 8.7 65.4 7 57.3 3.2 59.4 C -0.7 61.5 -0.6 74.6 11.6 78.6 C 15.8 80 19.6 80 22.7 79.9 C 23.5 79.9 30.4 79.2 32.8 75.8 C 35.2 72.4 33.5 71.5 32.7 71.1 C 31.8 70.6 25.3 74.4 21.9 73.8 Z ", stroke: "#001026", strokeWidth: "1.2", fill: "#FFAB19", strokeLinecap: "round", strokeLinejoin: "round" }), (0,jsx_runtime.jsx)("path", { d: "M 3.8 59.6 C 1.8 60.2 0.8 64.4 1.8 67.9 C 2.8 71.4 4.4 73.2 5.7 74.5 C 5.5 73.8 5.1 71.6 6.8 70.3 C 8.9 68.6 12.6 69.5 12.6 69.5 C 12.6 69.5 9.5 65.7 7.9 63 C 6.3 60.7 5.8 59.2 3.8 59.6 Z ", id: "detail", fill: "#FFFFFF", strokeWidth: "1" })] }), (0,jsx_runtime.jsx)("path", { d: "M37.7,81.5 C35.9,82.7 29.7,87.1 21.8,89.6 L21.4,89.7 C21,89.8 20.8,90.3 21,90.7 C22.7,93.1 25.8,97.9 20.3,99.6 C15,101.3 5.1,87.2 9.3,83.5 C11.2,82.1 12.9,82.8 13.8,83.2 C14.3,83.4 14.8,83.4 15.3,83.3 C16.5,82.9 18.7,82.1 20.4,81.2 C24.7,79 25.7,78.1 27.7,76.6 C29.7,75.1 34.3,71.4 38,74.6 C41.2,77.3 39.4,80.3 37.7,81.5 Z", id: "leg", stroke: "#001026", strokeWidth: "1.2", fill: "#FFAB19", strokeLinecap: "round", strokeLinejoin: "round" }), (0,jsx_runtime.jsx)("path", { d: "M53.6,60.7 C54.1,61.1 60.2,68.3 62.2,66.5 C64.6,64.4 67.9,60.3 71.5,63.6 C75.1,66.9 68.3,72.5 65.4,74 C58.5,77.1 52.9,71.2 51.7,69.6 C50.5,68 48.4,65.3 48.4,62.7 C48.5,59.9 51.9,59.2 53.6,60.7 Z", id: "arm", stroke: "#001026", strokeWidth: "1.2", fill: "#FFAB19", strokeLinecap: "round", strokeLinejoin: "round" }), (0,jsx_runtime.jsxs)("g", { id: "body-and-leg", children: [(0,jsx_runtime.jsx)("path", { d: "M 46.2 76.7 C 47.4 75.8 48.6 74.3 50.2 72 C 51.5 70.1 52.9 66.4 52.9 66.4 C 53.8 63.9 54.4 59.1 51.1 59.2 C 48.9 59.3 46.9 59 43.5 58.5 C 37.5 57.3 36.4 56.5 33.9 60.6 C 31.2 65.4 24.3 68.9 32.8 77.2 C 32.8 77.2 37.7 81 43.6 86.8 C 47.6 90.7 53.9 96.3 56.1 98.2 C 56.6 98.6 57.2 98.8 57.8 98.9 C 67.5 99.8 74.7 98.8 74.7 94.5 C 74.7 87.3 60.4 89.8 60.4 89.8 C 60.4 89.8 55.8 85.9 53.7 84 L 46.2 76.7 Z ", id: "body", stroke: "#001026", strokeWidth: "1.2", fill: "#FFAB19", strokeLinecap: "round", strokeLinejoin: "round" }), (0,jsx_runtime.jsx)("path", { d: "M 50.6 70 C 50.6 70 52.5 67.5 48.2 64.8 C 43.7 61.9 42 65.1 40.2 67.5 C 38.2 70.6 40.2 72.1 42.2 73.9 C 43.8 75.4 45.3 76.6 45.3 76.6 C 45.3 76.6 48.4 74.5 50.6 70 Z ", id: "tummy", fill: "#FFFFFF", strokeWidth: "1" })] }), (0,jsx_runtime.jsx)("path", { d: "M30.2,68.4 C32.4,71.2 35.8,74.7 31.5,77.6 C25.6,80.9 20.7,70.9 19.7,67.4 C18.8,64.3 21.4,62.3 23.6,60.6 C27.9,57.5 31.5,54.7 35.5,56.2 C40.5,58 36.9,62 34.4,63.8 C32.9,64.9 31.4,66.1 30.3,66.8 C30,67.3 29.9,67.9 30.2,68.4 Z", id: "arm", stroke: "#001026", strokeWidth: "1.2", fill: "#FFAB19", strokeLinecap: "round", strokeLinejoin: "round" }), (0,jsx_runtime.jsxs)("g", { id: "head", children: [(0,jsx_runtime.jsx)("path", { d: "M 53.1 9 C 50.8 8.6 48.4 8.4 45.6 8.6 C 40.9 8.8 36.4 10.5 36.4 10.5 L 24.3 2.6 C 23.9 2.4 23.4 2.7 23.5 3.1 L 25.6 21 C 26.2 20.2 15 33.8 22.1 45.2 C 29.2 56.6 44.3 61.7 63.1 58 C 81.9 54.3 86.3 43.5 85.1 37.8 C 83.9 32.1 76.8 30 76.8 30 C 76.8 30 76.7 25.5 73.5 20 C 71.6 16.7 65.2 12 65.2 12 L 62.6 1.3 C 62.5 0.9 62 0.8 61.7 1 L 53.1 9 Z ", stroke: "#001026", strokeWidth: "1.2", fill: "#FFAB19" }), (0,jsx_runtime.jsx)("path", { d: "M 76.5 30.4 C 76.5 30.4 83.4 32.2 84.6 37.9 C 85.8 43.6 81 53.9 62.4 57.5 C 38.2 62.5 26.7 48.1 33.4 37.5 C 40.1 26.8 51.6 35.9 60 35.3 C 67.2 34.8 68 28.5 76.5 30.4 Z ", id: "face", fill: "#FFFFFF", strokeWidth: "1" }), (0,jsx_runtime.jsx)("path", { d: "M 45 41.1 C 45 40.7 45.4 40.4 45.8 40.5 C 47.7 41.2 53.1 42.8 59.1 43.2 C 64.5 43.5 67.7 43.2 69.2 42.9 C 69.7 42.8 70.1 43.3 69.9 43.8 C 69 46.5 65.2 54 54.7 53.4 C 45.6 52.4 44.7 46 45 41.1 Z ", id: "mouth", stroke: "#001026", strokeWidth: "1.2", fill: "#FFFFFF", strokeLinecap: "round", strokeLinejoin: "round" }), (0,jsx_runtime.jsx)("path", { d: "M 83 35.4 C 83 35.4 90.2 35.3 94.9 31.5 ", id: "whisker", stroke: "#001026", strokeWidth: "1.2", strokeLinecap: "round", strokeLinejoin: "round", fill: "none" }), (0,jsx_runtime.jsx)("path", { d: "M 83.4 41.3 C 83.4 41.3 87.3 43.2 93.6 42.7 ", id: "whisker", stroke: "#001026", strokeWidth: "1.2", strokeLinecap: "round", strokeLinejoin: "round", fill: "none" }), (0,jsx_runtime.jsx)("path", { d: "M 59.6 32.7 C 61.7 32.7 63.9 32.9 64 33.6 C 64.1 35 62.6 37.8 61 37.9 C 59.2 38.1 55 35.6 55 34 C 54.9 32.8 57.6 32.7 59.6 32.7 Z ", id: "nose", stroke: "#001026", strokeWidth: "1.2", fill: "#001026", strokeLinecap: "round", strokeLinejoin: "round" }), (0,jsx_runtime.jsx)("path", { d: "M 14.6 31.2 C 14.6 31.2 23.2 34 26.7 37.1 ", id: "whisker", stroke: "#001026", strokeWidth: "1.2", strokeLinecap: "round", strokeLinejoin: "round", fill: "none" }), (0,jsx_runtime.jsx)("path", { d: "M 15.3 41.2 C 15.3 41.2 22.7 42.3 27 40.6 ", id: "whisker", stroke: "#001026", strokeWidth: "1.2", strokeLinecap: "round", strokeLinejoin: "round", fill: "none" }), (0,jsx_runtime.jsxs)("g", { id: "eye", children: [(0,jsx_runtime.jsx)("path", { d: "M 71.4 21 C 74.3 25.5 74.4 30.6 71.6 32.4 C 68.8 34.2 64.2 32.1 61.2 27.6 C 58.3 23.1 58.2 18 61 16.2 C 63.8 14.3 68.5 16.5 71.4 21 Z ", id: "pupil", stroke: "#001026", strokeWidth: "1.2", fill: "#FFFFFF", strokeLinecap: "round", strokeLinejoin: "round" }), (0,jsx_runtime.jsx)("path", { d: "M 71 26.7 C 71 27.8 70.2 28.7 69.2 28.7 C 68.2 28.7 67.4 27.8 67.4 26.7 C 67.4 25.6 68.2 24.7 69.2 24.7 C 70.2 24.7 71 25.6 71 26.7 ", id: "pupil", fill: "#001026", strokeWidth: "1" })] }), (0,jsx_runtime.jsxs)("g", { id: "eye", children: [(0,jsx_runtime.jsx)("path", { d: "M 46.6 23.8 C 49.6 28.2 49.4 33.6 46.7 35.5 C 43.4 37.4 39 36 36 31.6 C 32.9 27.2 32.7 21.5 35.8 19.3 C 38.9 17 43.6 19.4 46.6 23.8 Z ", stroke: "#001026", strokeWidth: "1.2", fill: "#FFFFFF", strokeLinecap: "round", strokeLinejoin: "round" }), (0,jsx_runtime.jsx)("path", { d: "M 46 29.6 C 46 30.7 45.2 31.6 44.2 31.6 C 43.2 31.6 42.4 30.7 42.4 29.6 C 42.4 28.5 43.2 27.6 44.2 27.6 C 45.2 27.7 46 28.5 46 29.6 ", id: "pupil", fill: "#001026", strokeWidth: "1" })] })] })] }) }) }) }) }));
}

;// ./src/components/DraggableSprite.tsx





const DraggableSprite_ItemTypes = {
    SPRITE: "sprite",
};
const DraggableSprite = ({ id, x, y, rotation, }) => {
    const dispatch = useDispatch();
    const speechBubble = useSelector((state) => { var _a; return (_a = state.sprites.byId[id]) === null || _a === void 0 ? void 0 : _a.speechBubble; });
    const [{ isDragging }, drag] = useDrag(() => ({
        type: DraggableSprite_ItemTypes.SPRITE,
    ...
    return ((0,jsx_runtime.jsxs)("div", { ref: drag, className: "absolute cursor-move transition-transform duration-500", style: {
            transform: `translate(${x}px, ${y}px) rotate(${rotation}deg)`,
            opacity: isDragging ? 0.5 : 1,
        }, children: [speechBubble && ((0,jsx_runtime.jsx)("div", { className: `${speechBubble.type === "say" ? "bg-white" : "bg-gray-300 italic"} text-black text-xs px-2 py-1 rounded shadow mb-1 absolute -top-6 left-1/2 -translate-x-1/2 whitespace-nowrap`, children: speechBubble.text })), (0,jsx_runtime.jsx)(CatSprite, {})] }));
};
/* harmony default export */ const components_DraggableSprite = (DraggableSprite);

;// ./src/components/PreviewArea.tsx
var PreviewArea_awaiter = (undefined && undefined.__awaiter) || function (thisArg, _arguments, P, generator) {
    function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); }
    return new (P || (P = Promise))(function (resolve, reject) {
        function fulfilled(value) { try { step(generator.next(value)); } catch (e) { reject(e); } }
        function rejected(value) { try { step(generator["throw"](value)); } catch (e) { reject(e); } }
...
const PreviewArea_delay = (ms) => new Promise((resolve) => setTimeout(resolve, ms));
function isColliding(a, b, threshold = 40) {
    const dx = a.x - b.x;
    const dy = a.y - b.y;
...
function PreviewArea() {
    const stopAllRef = (0,react.useRef)(false);
    const sprites = useSelector((state) => state.sprites.byId);
    const allIds = useSelector((state) => state.sprites.allIds);
    const actionSets = useSelector((state) => state.editor.actionSets);
    const dispatch = useDispatch();
    const runSequenceForSprite = (spriteId, sprite, actions) => PreviewArea_awaiter(this, void 0, void 0, function* () {
        let currentX = sprite.x;
        let currentY = sprite.y;
        let currentRotation = sprite.rotation;
        for (const action of actions) {
            if (stopAllRef.current)
                break;
            const result = yield executeAction(action, spriteId, sprite, actions, dispatch, currentX, currentY, currentRotation);
            currentX = result.x;
            currentY = result.y;
            currentRotation = result.rotation;
            if (action.id === "moveSteps") {
                for (const otherId of allIds) {
                    ...
                    if (isColliding({ x: currentX, y: currentY }, other)) {
                        ...
                        console.log(`💥 Collision detected between ${spriteId} and ${otherId}. Actions swapped.`);
                    }
                }
            }
            if (stopAllRef.current)
                break;
            yield PreviewArea_delay(500);
        }
    });
    const handlePlayAll = () => PreviewArea_awaiter(this, void 0, void 0, function* () {
    ...
    return ((0,jsx_runtime.jsxs)("div", { className: "relative w-full h-full bg-gray-100", children: [allIds.map((id) => {
                const sprite = sprites[id];
                return ((0,jsx_runtime.jsx)(components_DraggableSprite, { id: sprite.id, x: sprite.x, y: sprite.y, rotation: sprite.rotation }, id));
            }), (0,jsx_runtime.jsxs)("div", { className: "absolute bottom-4 left-4 flex space-x-4", children: [(0,jsx_runtime.jsx)(components_Button, { variant: "secondary", onClick: handlePlayAll, className: "px-4 py-2 bg-green-500 text-white rounded shadow", children: "Play All" }), (0,jsx_runtime.jsx)(components_Button, { variant: "danger", onClick: () => {
                            stopAllRef.current = true;
                        }, className: "px-4 py-2 text-white rounded shadow", children: "Stop All" })] })] }));
}
/* harmony default export */ const components_PreviewArea = (PreviewArea);

;// ./src/components/SpritePanel.tsx
...
function SpritePanel() {
    ...
    const allIds = useSelector((state) => state.sprites.allIds);
    const actionSets = useSelector((state) => state.editor.actionSets);
    const stateSelectedId = useSelector((state) => state.editor.selectedSpriteId);
    ...
    const handleAddSprite = () => {
        ...
        if (allIds.length > 0) {
            ...
            const clonedActions = ((_a = actionSets[firstId]) === null || _a === void 0 ? void 0 : _a.map((action) => (Object.assign({}, action)))) || [];
    ...
    return ((0,jsx_runtime.jsxs)("div", { className: "h-full p-4 bg-white border-t border-gray-300 flex flex-col", children: [(0,jsx_runtime.jsx)("h3", { className: "text-lg font-bold mb-2", children: "Sprites" }), (0,jsx_runtime.jsx)("div", { className: "flex flex-wrap gap-2", children: allIds.map((id) => {
                    const sprite = sprites[id];
                    return ((0,jsx_runtime.jsxs)("div", { onClick: () => handleSelect(id), className: `p-2 border rounded cursor-pointer flex flex-col items-center ${selectedId === id ? "border-blue-500" : "border-gray-300"}`, children: [(0,jsx_runtime.jsx)("div", { className: "scale-75", children: (0,jsx_runtime.jsx)(CatSprite, {}) }), (0,jsx_runtime.jsx)("button", { onClick: (e) => {
                                    e.stopPropagation();
                                    handleDeleteSprite(id);
                                }, className: "mt-1 text-red-500 text-xs", children: "Delete" })] }, id));
                }) }), (0,jsx_runtime.jsx)("div", { className: "flex", children: (0,jsx_runtime.jsx)("button", { onClick: handleAddSprite, className: "mt-4 px-4 py-2 bg-blue-500 text-white rounded", children: "Add Sprite" }) })] }));
}
/* harmony default export */ const components_SpritePanel = (SpritePanel);
...
function App() {
    return ((0,jsx_runtime.jsx)("div", { className: "bg-blue-100 pt-6 font-sans box-border h-screen", children: (0,jsx_runtime.jsxs)("div", { className: "h-full overflow-hidden flex flex-row", children: [(0,jsx_runtime.jsxs)("div", { className: "w-2/3 h-full overflow-hidden flex bg-white border-t border-r border-gray-200 rounded-tr-xl mr-2", children: [(0,jsx_runtime.jsx)(components_Sidebar, {}), (0,jsx_runtime.jsx)(MidArea, {})] }), (0,jsx_runtime.jsxs)("div", { className: "w-1/3 h-full overflow-hidden flex flex-col bg-white border-t border-l border-gray-200 rounded-tl-xl ml-2", children: [(0,jsx_runtime.jsx)(components_PreviewArea, {}), (0,jsx_runtime.jsx)(components_SpritePanel, {})] })] }) }));
}
...
function js_utils_typeof(obj) { "@babel/helpers - typeof"; if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { js_utils_typeof = function _typeof(obj) { return typeof obj; }; } else { js_utils_typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return js_utils_typeof(obj); }
...
function DragDropManagerImpl_defineProperty(obj, key, value) { if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }
...
var DragDropManagerImpl = /*#__PURE__*/function () {
  function DragDropManagerImpl(store, monitor) {
    ...
    DragDropManagerImpl_defineProperty(this, "store", void 0);

    DragDropManagerImpl_defineProperty(this, "monitor", void 0);

    DragDropManagerImpl_defineProperty(this, "backend", void 0);

    DragDropManagerImpl_defineProperty(this, "isSetUp", false);

    DragDropManagerImpl_defineProperty(this, "handleRefCountChange", function () {
...
var dragOffset_initialState = {
  initialSourceClientOffset: null,
  initialClientOffset: null,
  clientOffset: null
};
function reduce() {
  var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : dragOffset_initialState;
  ...
  switch (action.type) {
    ...
    case END_DRAG:
    case DROP:
      return dragOffset_initialState;
...
function DragDropMonitorImpl_defineProperty(obj, key, value) { if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }
...
var DragDropMonitorImpl = /*#__PURE__*/function () {
  function DragDropMonitorImpl(store, registry) {
    ...
    DragDropMonitorImpl_defineProperty(this, "store", void 0);

    DragDropMonitorImpl_defineProperty(this, "registry", void 0);
...
function validateType(type, allowArray) {
  ...
  invariant(typeof type === 'string' || contracts_typeof(type) === 'symbol', allowArray ? 'Type can only be a string, a symbol, or an array of either.' : 'Type can only be a string or a symbol.');
}
...
function HandlerRegistryImpl_defineProperty(obj, key, value) { if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }

function HandlerRegistryImpl_slicedToArray(arr, i) { return HandlerRegistryImpl_arrayWithHoles(arr) || HandlerRegistryImpl_iterableToArrayLimit(arr, i) || HandlerRegistryImpl_unsupportedIterableToArray(arr, i) || HandlerRegistryImpl_nonIterableRest(); }

function HandlerRegistryImpl_nonIterableRest() { throw new TypeError("Invalid attempt to destructure non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); }

function HandlerRegistryImpl_unsupportedIterableToArray(o, minLen) { if (!o) return; if (typeof o === "string") return HandlerRegistryImpl_arrayLikeToArray(o, minLen); var n = Object.prototype.toString.call(o).slice(8, -1); if (n === "Object" && o.constructor) n = o.constructor.name; if (n === "Map" || n === "Set") return Array.from(o); if (n === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)) return HandlerRegistryImpl_arrayLikeToArray(o, minLen); }

function HandlerRegistryImpl_arrayLikeToArray(arr, len) { if (len == null || len > arr.length) len = arr.length; for (var i = 0, arr2 = new Array(len); i < len; i++) { arr2[i] = arr[i]; } return arr2; }

function HandlerRegistryImpl_iterableToArrayLimit(arr, i) { var _i = arr == null ? null : typeof Symbol !== "undefined" && arr[Symbol.iterator] || arr["@@iterator"]; if (_i == null) return; var _arr = []; var _n = true; var _d = false; var _s, _e; try { for (_i = _i.call(arr); !(_n = (_s = _i.next()).done); _n = true) { _arr.push(_s.value); if (i && _arr.length === i) break; } } catch (err) { _d = true; _e = err; } finally { try { if (!_n && _i["return"] != null) _i["return"](); } finally { if (_d) throw _e; } } return _arr; }

function HandlerRegistryImpl_arrayWithHoles(arr) { if (Array.isArray(arr)) return arr; }
...
function mapContainsValue(map, searchValue) {
  ...
  do {
    var _entries$next = entries.next(),
        ...
        _entries$next$value = HandlerRegistryImpl_slicedToArray(_entries$next.value, 2),
...
var HandlerRegistryImpl = /*#__PURE__*/function () {
  function HandlerRegistryImpl(store) {
    ...
    HandlerRegistryImpl_defineProperty(this, "types", new Map());

    HandlerRegistryImpl_defineProperty(this, "dragSources", new Map());

    HandlerRegistryImpl_defineProperty(this, "dropTargets", new Map());

    HandlerRegistryImpl_defineProperty(this, "pinnedSourceId", null);

    HandlerRegistryImpl_defineProperty(this, "pinnedSource", null);

    HandlerRegistryImpl_defineProperty(this, "store", void 0);
...
var DndProvider_excluded = ["children"];

function DndProvider_slicedToArray(arr, i) { return DndProvider_arrayWithHoles(arr) || DndProvider_iterableToArrayLimit(arr, i) || DndProvider_unsupportedIterableToArray(arr, i) || DndProvider_nonIterableRest(); }

function DndProvider_nonIterableRest() { throw new TypeError("Invalid attempt to destructure non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); }

function DndProvider_unsupportedIterableToArray(o, minLen) { if (!o) return; if (typeof o === "string") return DndProvider_arrayLikeToArray(o, minLen); var n = Object.prototype.toString.call(o).slice(8, -1); if (n === "Object" && o.constructor) n = o.constructor.name; if (n === "Map" || n === "Set") return Array.from(o); if (n === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)) return DndProvider_arrayLikeToArray(o, minLen); }

function DndProvider_arrayLikeToArray(arr, len) { if (len == null || len > arr.length) len = arr.length; for (var i = 0, arr2 = new Array(len); i < len; i++) { arr2[i] = arr[i]; } return arr2; }

function DndProvider_iterableToArrayLimit(arr, i) { var _i = arr == null ? null : typeof Symbol !== "undefined" && arr[Symbol.iterator] || arr["@@iterator"]; if (_i == null) return; var _arr = []; var _n = true; var _d = false; var _s, _e; try { for (_i = _i.call(arr); !(_n = (_s = _i.next()).done); _n = true) { _arr.push(_s.value); if (i && _arr.length === i) break; } } catch (err) { _d = true; _e = err; } finally { try { if (!_n && _i["return"] != null) _i["return"](); } finally { if (_d) throw _e; } } return _arr; }

function DndProvider_arrayWithHoles(arr) { if (Array.isArray(arr)) return arr; }

function _objectWithoutProperties(source, excluded) { if (source == null) return {}; var target = DndProvider_objectWithoutPropertiesLoose(source, excluded); var key, i; if (Object.getOwnPropertySymbols) { var sourceSymbolKeys = Object.getOwnPropertySymbols(source); for (i = 0; i < sourceSymbolKeys.length; i++) { key = sourceSymbolKeys[i]; if (excluded.indexOf(key) >= 0) continue; if (!Object.prototype.propertyIsEnumerable.call(source, key)) continue; target[key] = source[key]; } } return target; }
...
var DndProvider = (0,react.memo)(function DndProvider(_ref) {
  var children = _ref.children,
      props = _objectWithoutProperties(_ref, DndProvider_excluded);

  var _getDndContextValue = getDndContextValue(props),
      _getDndContextValue2 = DndProvider_slicedToArray(_getDndContextValue, 2),
  ...
  return (0,jsx_runtime.jsx)(DndContext.Provider, Object.assign({
    value: manager
  }, {
    children: children
  }), void 0);
...
function EnterLeaveCounter_defineProperty(obj, key, value) { if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }
...
var EnterLeaveCounter = /*#__PURE__*/function () {
  function EnterLeaveCounter(isNodeInDocument) {
    ...
    EnterLeaveCounter_defineProperty(this, "entered", []);

    EnterLeaveCounter_defineProperty(this, "isNodeInDocument", void 0);
...
function MonotonicInterpolant_defineProperty(obj, key, value) { if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }

var MonotonicInterpolant = /*#__PURE__*/function () {
  function MonotonicInterpolant(xs, ys) {
    MonotonicInterpolant_classCallCheck(this, MonotonicInterpolant);

    MonotonicInterpolant_defineProperty(this, "xs", void 0);

    MonotonicInterpolant_defineProperty(this, "ys", void 0);

    MonotonicInterpolant_defineProperty(this, "c1s", void 0);

    MonotonicInterpolant_defineProperty(this, "c2s", void 0);

    MonotonicInterpolant_defineProperty(this, "c3s", void 0);
...
var nativeTypesConfig = (_nativeTypesConfig = {}, nativeTypesConfig_defineProperty(_nativeTypesConfig, FILE, {
  ...
  matchesTypes: ['Files']
}), nativeTypesConfig_defineProperty(_nativeTypesConfig, HTML, {
  exposeProperties: {
...
function NativeDragSource_defineProperty(obj, key, value) { if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }

var NativeDragSource = /*#__PURE__*/function () {
  function NativeDragSource(config) {
    NativeDragSource_classCallCheck(this, NativeDragSource);

    NativeDragSource_defineProperty(this, "item", void 0);

    NativeDragSource_defineProperty(this, "config", void 0);
...
function OptionsReader_defineProperty(obj, key, value) { if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }
...
var OptionsReader = /*#__PURE__*/function () {
  function OptionsReader(globalContext, options) {
    ...
    OptionsReader_defineProperty(this, "ownerDocument", null);

    OptionsReader_defineProperty(this, "globalContext", void 0);

    OptionsReader_defineProperty(this, "optionsArgs", void 0);
...
function HTML5BackendImpl_ownKeys(object, enumerableOnly) { var keys = Object.keys(object); if (Object.getOwnPropertySymbols) { var symbols = Object.getOwnPropertySymbols(object); if (enumerableOnly) { symbols = symbols.filter(function (sym) { return Object.getOwnPropertyDescriptor(object, sym).enumerable; }); } keys.push.apply(keys, symbols); } return keys; }

function HTML5BackendImpl_objectSpread(target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i] != null ? arguments[i] : {}; if (i % 2) { HTML5BackendImpl_ownKeys(Object(source), true).forEach(function (key) { HTML5BackendImpl_defineProperty(target, key, source[key]); }); } else if (Object.getOwnPropertyDescriptors) { Object.defineProperties(target, Object.getOwnPropertyDescriptors(source)); } else { HTML5BackendImpl_ownKeys(Object(source)).forEach(function (key) { Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key)); }); } } return target; }
...
var HTML5BackendImpl = /*#__PURE__*/function () {
  ...
  function HTML5BackendImpl(manager, globalContext, options) {
    ...
    HTML5BackendImpl_defineProperty(this, "options", void 0);

    HTML5BackendImpl_defineProperty(this, "actions", void 0);

    HTML5BackendImpl_defineProperty(this, "monitor", void 0);

    HTML5BackendImpl_defineProperty(this, "registry", void 0);

    HTML5BackendImpl_defineProperty(this, "enterLeaveCounter", void 0);

    HTML5BackendImpl_defineProperty(this, "sourcePreviewNodes", new Map());

    HTML5BackendImpl_defineProperty(this, "sourcePreviewNodeOptions", new Map());

    HTML5BackendImpl_defineProperty(this, "sourceNodes", new Map());

    HTML5BackendImpl_defineProperty(this, "sourceNodeOptions", new Map());

    HTML5BackendImpl_defineProperty(this, "dragStartSourceIds", null);

    HTML5BackendImpl_defineProperty(this, "dropTargetIds", []);

    HTML5BackendImpl_defineProperty(this, "dragEnterTargetIds", []);

    HTML5BackendImpl_defineProperty(this, "currentNativeSource", null);

    HTML5BackendImpl_defineProperty(this, "currentNativeHandle", null);

    HTML5BackendImpl_defineProperty(this, "currentDragSourceNode", null);

    HTML5BackendImpl_defineProperty(this, "altKeyPressed", false);

    HTML5BackendImpl_defineProperty(this, "mouseMoveTimeoutTimer", null);

    HTML5BackendImpl_defineProperty(this, "asyncEndDragFrameId", null);

    HTML5BackendImpl_defineProperty(this, "dragOverTargetIds", null);

    HTML5BackendImpl_defineProperty(this, "lastClientOffset", null);

    HTML5BackendImpl_defineProperty(this, "hoverRafId", null);

    HTML5BackendImpl_defineProperty(this, "getSourceClientOffset", function (sourceId) {
      var source = _this.sourceNodes.get(sourceId);

      return source && getNodeClientOffset(source) || null;
    });

    HTML5BackendImpl_defineProperty(this, "endDragNativeItem", function () {
    ...
    HTML5BackendImpl_defineProperty(this, "isNodeInDocument", function (node) {
      // Check the node either in the main document or in the current context
      return Boolean(node && _this.document && _this.document.body && _this.document.body.contains(node));
    });

    HTML5BackendImpl_defineProperty(this, "endDragIfSourceWasRemovedFromDOM", function () {
    ...
    HTML5BackendImpl_defineProperty(this, "handleTopDragStartCapture", function () {
      _this.clearCurrentDragSourceNode();

      _this.dragStartSourceIds = [];
    });

    HTML5BackendImpl_defineProperty(this, "handleTopDragStart", function (e) {
    ...
    HTML5BackendImpl_defineProperty(this, "handleTopDragEndCapture", function () {
      if (_this.clearCurrentDragSourceNode() && _this.monitor.isDragging()) {
    ...
    HTML5BackendImpl_defineProperty(this, "handleTopDragEnterCapture", function (e) {
    ...
    HTML5BackendImpl_defineProperty(this, "handleTopDragEnter", function (e) {
    ...
    HTML5BackendImpl_defineProperty(this, "handleTopDragOverCapture", function () {
      _this.dragOverTargetIds = [];
    });

    HTML5BackendImpl_defineProperty(this, "handleTopDragOver", function (e) {
    ...
    HTML5BackendImpl_defineProperty(this, "handleTopDragLeaveCapture", function (e) {
      if (_this.isDraggingNativeItem()) {
        e.preventDefault();
      }
    ...
    HTML5BackendImpl_defineProperty(this, "handleTopDropCapture", function (e) {
      _this.dropTargetIds = [];
    ...
    HTML5BackendImpl_defineProperty(this, "handleTopDrop", function (e) {
    ...
    HTML5BackendImpl_defineProperty(this, "handleSelectStart", function (e) {
...
var redux_$$observable = /* @__PURE__ */ (() => typeof Symbol === "function" && Symbol.observable || "@@observable")();
var symbol_observable_default = redux_$$observable;

// src/utils/actionTypes.ts
var redux_randomString = () => Math.random().toString(36).substring(7).split("").join(".");
var redux_ActionTypes = {
  INIT: `@@redux/INIT${/* @__PURE__ */ redux_randomString()}`,
  REPLACE: `@@redux/REPLACE${/* @__PURE__ */ redux_randomString()}`,
  PROBE_UNKNOWN_ACTION: () => `@@redux/PROBE_UNKNOWN_ACTION${redux_randomString()}`
};
var actionTypes_default = redux_ActionTypes;
...
function redux_miniKindOf(val) {
  ...
  if (redux_isError(val))
    return "error";
  const constructorName = redux_ctorName(val);
  switch (constructorName) {
    case "Symbol":
    case "Promise":
    case "WeakMap":
...
function redux_createStore(reducer, preloadedState, enhancer) {
  ...
  function dispatch(action) {
    ...
    if (typeof action.type !== "string") {
      throw new Error( true ? redux_formatProdErrorMessage(17) : 0);
    }
    if (isDispatching) {
...
function redux_legacy_createStore(reducer, preloadedState, enhancer) {
  return redux_createStore(reducer, preloadedState, enhancer);
}
...
function dist_redux_bindActionCreators(actionCreators, dispatch) {
  if (typeof actionCreators === "function") {
...
function redux_applyMiddleware(...middlewares) {
...
const rootReducer = redux_combineReducers({
    sprites: spriteReducer,
    editor: reducers_editorReducer,
});
...
const store = redux_createStore(reducers);
...
react_dom.render((0,jsx_runtime.jsx)(react.StrictMode, { children: (0,jsx_runtime.jsx)(components_Provider, { store: redux_store, children: (0,jsx_runtime.jsx)(DndProvider, { backend: HTML5Backend, children: (0,jsx_runtime.jsx)(App, {}) }) }) }), document.getElementById("root"));
